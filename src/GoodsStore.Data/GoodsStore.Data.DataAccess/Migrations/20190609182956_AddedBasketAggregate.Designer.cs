...
namespace GoodsStore.Data.DataAccess.Migrations
{
    ...
    [Migration("20190609182956_AddedBasketAggregate")]
    partial class AddedBasketAggregate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.BasketAggregate.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.HasOne("GoodsStore.Core.Domain.Entities.BasketAggregate.Basket")
                        .WithMany("Items")
