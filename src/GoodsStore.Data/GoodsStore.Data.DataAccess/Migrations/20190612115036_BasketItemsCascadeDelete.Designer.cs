...
namespace GoodsStore.Data.DataAccess.Migrations
{
    ...
    [Migration("20190612115036_BasketItemsCascadeDelete")]
    partial class BasketItemsCascadeDelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.ComparisonBasketAggregate.ComparisonBasket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.ComparisonBasketAggregate.ComparisonBasketItem", b =>
                {
                    ...
                    b.Property<int>("ComparisonBasketId");
            ...
            modelBuilder.Entity("GoodsStore.Core.Domain.Entities.ComparisonBasketAggregate.ComparisonBasketItem", b =>
                {
                    b.HasOne("GoodsStore.Core.Domain.Entities.ComparisonBasketAggregate.ComparisonBasket", "ComparisonBasket")
                        .WithMany("Items")
                        .HasForeignKey("ComparisonBasketId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
